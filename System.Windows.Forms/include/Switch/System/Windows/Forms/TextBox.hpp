  ...
  namespace System {
    ...
    namespace Windows {
      ...
      namespace Forms {
        ...
        class system_windows_forms_export_ TextBox : public Control {
        public:
            TextBox() : Control("", 0, 0, 100, 18) {
                this->SetStyle(ControlStyles::UserPaint, false);
            }
            /// @cond
            TextBox(const TextBox& textbox) : Control(textbox){ };
            /// @endcond

        protected:
            void CreateHandle() override;
            System::Drawing::Size GetDefaultSize() const override { return System::Drawing::Size(100, 18); }
            /// @endcond
        };
      }
    }
